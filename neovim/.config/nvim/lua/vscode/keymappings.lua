...
-- --folding
vim.keymap.set({ "n" }, "zr", api.fold.openAll)
vim.keymap.set({ "n" }, "zi", api.fold.toggle)
vim.keymap.set({ "n" }, "zO", api.fold.openRecursive)
vim.keymap.set({ "n" }, "zo", api.fold.open)
vim.keymap.set({ "n" }, "zc", api.fold.close)
vim.keymap.set({ "n" }, "zC", api.fold.all)
-- --#endregion keymap
